...
public class StocksEfficient {
	...
	public void noInput() {
		int[] stockPrices = {};
		assertEquals(0, main.getMaxProfitEfficient(stockPrices));
	}
	...
	public void profit() {
		int[] stockPrices = {4, 9};
		assertEquals(5, main.getMaxProfitEfficient(stockPrices));
	}
	
	@Test
	public void standardCase() {
		int[] stockPrices = {10, 7, 5, 8, 11, 9};
		assertEquals(6, main.getMaxProfitEfficient(stockPrices));
	}
	
	@Test
	public void notHighestSell() {
		int[] stockPrices = {8, 17, 5, 8, 16, 9};
		assertEquals(11, main.getMaxProfitEfficient(stockPrices));
	}
