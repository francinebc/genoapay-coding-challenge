...
public class StocksNegativeOk {
	...
	public void noInput() {
		int[] stockPrices = {};
		assertEquals(0, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
	...
	public void negativeProfit() {
		...
		assertEquals(-1, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
	
	@Test
	public void profit() {
		int[] stockPrices = {4, 9};
		assertEquals(5, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
	
	@Test
	public void standardCase() {
		int[] stockPrices = {10, 7, 5, 8, 11, 9};
		assertEquals(6, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
	
	@Test
	public void notHighestSell() {
		int[] stockPrices = {8, 17, 5, 8, 16, 9};
		assertEquals(11, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
	...
	public void longStockList() {
		...
		assertEquals(99, Stocks.getMaxProfitNegativeOk(stockPrices));
	}
